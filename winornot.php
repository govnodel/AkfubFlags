...
<body>
  ...
  <table>
    <tr>
      ...
      if ($score - $scoreOld > 0) {echo "+".$score - $scoreOld;} else {echo $score - $scoreOld;}
      ?></td><td><?=$score?></td>
    </tr>
    <tr>
      <td>ACCURACY</td><td><?=$ansProcOld?></td><td><?php
      if ($ansProc - $ansProcOld > 0) {echo "+".$ansProc - $ansProcOld;} else {echo $ansProc - $ansProcOld;}
      ?></td><td><?=$ansProc?></td>
    </tr>
    <tr>
      <td>GAMES</td><td><?=$gamesOld?></td><td><?php
      if ($games - $gamesOld > 0) {echo "+".$games - $gamesOld;} else {echo $games - $gamesOld;}
      ?></td><td><?=$games?></td>
    </tr>
    <tr>
